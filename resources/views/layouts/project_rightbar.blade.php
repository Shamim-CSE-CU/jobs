  ...
  <aside class="col-lg-4 sidebar-home">
    ...
    <div class="capcha_image">
      ...
      <div class="capcha_image-content">
        ...
        <p class="text-black" style="font-size: 20px;"><span class="woocommerce-Price-currencySymbol">৳&nbsp;</span>{{$projects->payment}}</p>
        
        <button type="button" class="btn btn-secondary" onclick="predict_image()" style="background-color: rgb(118, 118, 204)">Submit a Proposal</button>
      </div>
    </div>
    ...
    <div class="widget widget-categories">
      ...
      <ul class="list-unstyled widget-list">
        ...
        <li class="d-flex"><a href="{{ '/posts/category/' . $projects->category_id }}">{{ $projects->category_name }}</a></li>
    ...
    <div class="widget widget-author">
      ...
      <div class="media align-items-center">
        <div class="mr-3">
          <img class="widget-author-image" src="{{ asset('images/user_photos/' . $projects->user_photo) }}">
        </div>
        <div class="media-body">
          <h5 class="mb-1"><a class="post-title" href="">{{$projects->user_name}}</a></h5>
