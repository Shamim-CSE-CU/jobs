...
{{-- <div class="vidoe swiper-container" id="posts-container" style="padding-left:70px; padding-right: 70px; padding-bottom:30px;">
    ...
    <div class="container">
        ...
        <div class="col-md-5 text-md-right text-center mb-4">
            ...
            <li class="list-inline-item"><a href="https://www.facebook.com/profile.php?id=100008406361771"><i class="ti-facebook"></i></a></li>
            
            <li class="list-inline-item"><a href="https://twitter.com/login"><i class="ti-twitter-alt"></i></a></li>
            
            <li class="list-inline-item"><a href="https://www.linkedin.com/"><i class="ti-linkedin"></i></a></li>
            
            <li class="list-inline-item"><a href="https://github.com/Shamim-CSE-CU/pd?fbclid=IwAR3lkXIHCtaNWm1ZUinDOgH_eMCMpT94EnVcFcZ_R7DgFUp9VqMbCt5rltc"><i class="ti-github"></i></a></li>
            
            <li class="list-inline-item"><a href="https://www.youtube.com/"><i class="ti-youtube"></i></a></li>
