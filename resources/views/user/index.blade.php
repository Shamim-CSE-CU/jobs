    ...
    <section class="section-sm">
      ...
      <div class="col-lg-12 mt-5  mb-5 mb-lg-0">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            @auth
            <a href="" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#AddProjectModel"><i class="fas fa-plus text-white-50 mr-1"></i>প্রোজেক্ট তৈরি করি</a>
            @else
            <a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="{{route('login')}}"><i class="fas fa-plus text-white-50 mr-1"></i>প্রোজেক্ট তৈরি করি</a>
            @endauth
                                ...
                                <div class="card-body card_body_project">
                                    <div class="grid_item_1" >
                                                ...
                                                <a class="" href="#" role="button">
                                                            ...
                                                            @if ($project->user_photo)
                                                                <img src="{{ asset('images/user_photos/' . $project->user_photo) }}" alt="" class="rounded-circle" style="height: 60px">
                                                            @else
                                    ...
                                    padding: 5px;">
                                        <i class="fas fa-heart" style="color: #ccafaf;padding-left: 2px; cursor: pointer; "></i>
                                            ...
                                            <a href="{{route('single_project_view', $project->id) }}">
                                            <h5 class="post-subject" >{{$project->title}}</h4>
                                            </a>
                                            <h5 class="mb-3" ><a class="post-title" style="background: white;
                                            color:rgb(142, 145, 145);
                                            font-size:20px;
                                                border-radius: 7px;
                                                padding: 5px;" >{{ $project->user_name }}</a></h5>
                                                <div class="grid_item_2_bottom">
                                                    <div class="grid_item_2_bottom_item_1">                     
                                                        <li class="list-inline-item" style="font-size: 13px;">
                                                            <i class="ti-calendar" style="margin-right: 5px;"></i>{{date('d M Y', strtotime($project->created_at))}}
                                                        </li>
                                                    </div>
                                                    <div class="grid_item_2_bottom_item_2">
                                                        <li class="list-inline-item">
                                                            <div style="overflow: hidden; text-overflow: ellipsis; ">
                                                                <b class="" style="font-size: 10px;"><i class="fas fa-map-marker-alt location-icon" style="font-size: 16px; margin-right:5px; color:rgb(194 199 215);"></i>{{ $project->Location }}</b>
                                                            </div>
                                                        </li>
                                                    </div>
                                                    <div class="grid_item_2_bottom_item_3">
                                                        <li class="list-inline-item">
                                                            <div class="project-proposals-count with-icon"><i class="fas fa-rocket rocket-icon" style="color: rgb(194 199 215);"></i> 5 Proposals</div>
                                                        </li>
                                                    </div>
                                                </div>
...
<!-- project_create add Modal-->
<div class="modal" id="AddProjectModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Project Create</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <form action="{{route('project_create')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="post_name">Project Title</label>
                                <input type="text" class="form-control @error('title') is-invalid @enderror " name="title" value="{{ old('title')}}" >
                                @error('title')
                            ...
                            <div class="form-group">
                                <label for="post_name">Project Category</label>
                                <select name="category_id" class="form-control">
                                    <option selected disabled>Select Category</option>
                                    @foreach ($categories as $category)
                            ...
                            <div class="form-group">
                                <label for="post_name">Project Description</label>
                                <textarea class="summernote form-control @error('description') is-invalid @enderror " name="description" rows="7">{{ old('description')}}</textarea>
                                @error('description')
