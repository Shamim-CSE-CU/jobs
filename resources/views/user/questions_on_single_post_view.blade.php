      ...
      <div class="row justify-content-center">
        <div class="col-lg-8  mb-5 mb-lg-0">
          ...
          @foreach ($questions as $question)
              ...
              <div class="card mt-4 border" style="width: 700px">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center mb-4">
                    <a href="{{route('question_answers', $question->id)}}" class="btn-link h4" style="width:90%;">{{ $question->question}}</a>
          ...
          <form action="{{route('question_store')}}" method="post">
            ...
            <div class="form-group mb-3">
                <input style="display: none;" type="text" name="services_id" value="{{$services->id}}">
